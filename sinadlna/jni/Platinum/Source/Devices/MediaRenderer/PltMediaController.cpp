                                            ...
                                            void*                    userdata)
{
    ...
    if (NPT_FAILED(PLT_MediaControllerTool::ParseTimeStamp(value, info.media_duration))) {
        goto bad_action;
    }
                                               ...
                                               void*                    userdata)
{
    ...
    if (NPT_FAILED(PLT_MediaControllerTool::ParseTimeStamp(value, info.track_duration))) {
	...
	if (value != "NOT_IMPLEMENTED" && NPT_FAILED(PLT_MediaControllerTool::ParseTimeStamp(value, info.rel_time))) {
	...
	// NOT_IMPLEMENTED is a valid value according to spec
	if (value != "NOT_IMPLEMENTED" && NPT_FAILED(PLT_MediaControllerTool::ParseTimeStamp(value, info.abs_time))) {
		// some dogy renderers return garbage sometimes
